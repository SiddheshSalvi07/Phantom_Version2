...
- No auth is implemented in this MVP — TODO: add authentication, rate-limiting, and authz before production.
...
TODO (high level):
- TODO: Model routing, A2A flows, vector DB integration (Qdrant), wake-word STT, advanced plan generator.
